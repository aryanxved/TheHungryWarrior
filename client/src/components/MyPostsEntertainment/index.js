...
const MyPostsEntertainment = () => {
  ...
  //----------------------API---------------
    ...
    const callApiGetPosts = async () => {
        ...
        const url = serverURL + "/api/getPostsEntertainment";
        ...
        const callApiGetPostsByID = async () => {
            ...
            const url = serverURL + "/api/getPostsEntertainmentByID";
        ...
        const callApiGetPostsByIDDelete = async () => {
                ...
                const url = serverURL + "/api/getPostsEntertainmentByIDDelete";
        ...
        <div style={{marginTop: '50px'}}>
          ...
          <div>
            <div>
                ...
                >
                  Post ID Number: {option.entertainmentID}
                </Typography>
                </Card>
                </div>
            </div>
...
export default MyPostsEntertainment;
