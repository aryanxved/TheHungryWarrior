...
export default function ReviewRestaurant() {
    ...
    return (
      ...
      <FormControl variant="outlined" style={{marginTop: "30px", width: "100vh"}}>
        ...
        <Select        >
                <MenuItem value ={1}> {'Subway'} </MenuItem>
                <MenuItem value ={2}> {'McDonalds'} </MenuItem>
                <MenuItem value ={3}> {'Harveys'} </MenuItem>
                <MenuItem value ={4}> {'Shinwa'} </MenuItem>
                <MenuItem value ={5}> {'Burger King'} </MenuItem>
        </Select>
      </FormControl>
    </div>
    <p style={{marginTop: '25px'}}></p>
      ...
      <FormControl variant="outlined" style={{marginTop: "30px", width: "100vh"}}>
        <InputLabel>Enter Quality Rating</InputLabel>
        <Select        >
