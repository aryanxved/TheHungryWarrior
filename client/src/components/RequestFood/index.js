...
function RequestTitle(props) {
  ...
  return (
    ...
    <div align="center">
              ...
              >
                <b>What's the Restaurant Name?</b>
              </Typography>
...
function RequestLocation(props) {
  ...
  return (
    ...
    <Typography
                ...
                style={{fontFamily: 'roboto', color: 'black'}}
              >
                <b>What is the address of the Restaurant?</b>
              </Typography>
...
function RequestFood() {
  ...
  const callApiAddRequest = async () => {
    ...
    const url = serverURL + "/api/addRequestRestaurant";

    const submittedReview = {
      "RestaurantName": requestTitle,
      "RestaurantAddress": requestLocation,
      "RestaurantInfo": requestDescription,
