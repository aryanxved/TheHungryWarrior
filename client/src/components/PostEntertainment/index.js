...
function PostEntertainment() {
  ...
  const [entertainmentAddress, setPostLocation] = useState("")
  
  const [entertainmentName, setPostTitle] = useState("")

  const [entertainmentDest, setPostDescription] = useState("")
  
  const [postQuality, setPostQuality] = useState("")

  const [postInfo, setPostInfo] = useState("")

  const [entertainmentUserName, setPostName] = useState("")

  const [entertainmentUserEmail, setPostEmail] = useState(currentUser.email)

  const [entertainmentUserPhone, setPostPhone] = useState("")
  ...
  const callApiAddPost = async () => {
    ...
    const url = serverURL + "/api/addPostEntertainment";

    const submittedReview = {
      "entertainmentName": entertainmentName,
      "entertainmentAddress": entertainmentAddress,
      "entertainmentDest": entertainmentDest,
      "entertainmentUserName": entertainmentUserName,
      "entertainmentUserEmail": entertainmentUserEmail,
      "entertainmentUserPhone": entertainmentUserPhone,
    ...
    //entertainmentBudget
    //entertainmentDistance
    //entertainmentActivity
    //entertainmentLevel
    //entertainmentName
    //entertainmentDest
    //entertainmentAddress
    //entertainmentUserName
    //entertainmentUserPhone
    //entertainmentUserEmail 
  ...
  const submitButton = () => {
      ...
      setPostInfo(
        ...
        <div style={{fontSize: "14px", marginTop: "10px"}}>What is this experience about? <br/>{entertainmentName}</div>
        <br/>
        <div style={{fontSize: "14px", marginTop: "10px"}}>The location you selected is: <br/>{entertainmentAddress}</div>
        <br/>
        <div style={{fontSize: "14px", marginTop: "10px"}}>What the details behind your experience are? <br/>{entertainmentDest}</div>
        <br/>
        <div style={{fontSize: "14px", marginTop: "10px"}}>What your name is? <br/>{entertainmentUserName}</div>
        <br/>
        <div style={{fontSize: "14px", marginTop: "10px"}}>What your email is? <br/>{entertainmentUserEmail}</div>
        <br/>
        <div style={{fontSize: "14px", marginTop: "10px"}}>What your phone number is? <br/>{entertainmentUserPhone}</div>
        <br/>
...
function SubmitButton(props) {
  ...
  export default (PostEntertainment);
